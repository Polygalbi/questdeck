...
type View = "overview" | "quests" | "timeline" | "mindmap" | "documents" | "milestones" | "activity" | "management" | "projects-management" | "roles" | "account";
...
const initialRoleDefinitions: RoleDefinition[] = [
  ...
  { name: "Admin", description: "Manage projects and production settings in assigned workspaces.", color: "coral", permissions: { view_projects: true, edit_cards: true, manage_members: true, workspace_settings: true, billing_security: false } },
...
function isView(value: string): value is View {
  return ["overview", "quests", "timeline", "mindmap", "documents", "milestones", "activity", "management", "projects-management", "roles", "account"].includes(value);
}
